...
export class Practice extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.backgroundImage({ "id": 16777281, "type": 20000, params: [], "bundleName": "com.example.yxsport", "moduleName": "entry" });
        ...
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777286, "type": 20000, params: [], "bundleName": "com.example.yxsport", "moduleName": "entry" });
            Image.width(24);
            Image.height(24);
            Image.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //图表                                       //暂时贴图
            Image.create({ "id": 16777282, "type": 20000, params: [], "bundleName": "com.example.yxsport", "moduleName": "entry" });
            //图表                                       //暂时贴图
            Image.margin({ top: 15 });
            //图表                                       //暂时贴图
            Image.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            //图表                                       //暂时贴图
            Image.create({ "id": 16777283, "type": 20000, params: [], "bundleName": "com.example.yxsport", "moduleName": "entry" });
            //图表                                       //暂时贴图
            Image.margin({ top: 15 });
            //图表                                       //暂时贴图
            Image.width('100%');
