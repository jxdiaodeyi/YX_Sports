...
interface LoadingProgressView_Params {
...
export class LoadingProgressView extends ViewPU {
    ...
    setInitiallyProvidedValue(params: LoadingProgressView_Params) {
        if (params.content !== undefined) {
            this.content = params.content;
        }
    }
    updateStateVars(params: LoadingProgressView_Params) {
    ...
    private __options: SynchedPropertySimpleOneWayPU<LoadingProgressOptions>;
    get options() {
        return this.__options.get();
    }
    set options(newValue: LoadingProgressOptions) {
