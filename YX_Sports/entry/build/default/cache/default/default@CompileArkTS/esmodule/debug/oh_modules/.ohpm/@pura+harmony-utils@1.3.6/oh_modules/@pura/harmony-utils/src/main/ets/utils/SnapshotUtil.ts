...
export class SnapshotUtil {
     ...
     * @returns
     */
    static createFromBuilder(builder: CustomBuilder, delay: number = 300, checkImageStatus: boolean = false, options?: componentSnapshot.SnapshotOptions): Promise<image.PixelMap> {
