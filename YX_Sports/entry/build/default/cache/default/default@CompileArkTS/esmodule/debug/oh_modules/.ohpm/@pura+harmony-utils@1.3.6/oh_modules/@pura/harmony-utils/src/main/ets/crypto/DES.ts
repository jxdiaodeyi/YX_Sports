...
export class DES {
     ...
     * @returns
     */
    static async encryptCBC(data: cryptoFramework.DataBlob, symKey: cryptoFramework.SymKey, params: cryptoFramework.ParamsSpec): Promise<cryptoFramework.DataBlob> {
     ...
     * @returns
     */
    static encryptCBCSync(data: cryptoFramework.DataBlob, symKey: cryptoFramework.SymKey, params: cryptoFramework.ParamsSpec): cryptoFramework.DataBlob {
     ...
     * @returns
     */
    static async decryptCBC(data: cryptoFramework.DataBlob, symKey: cryptoFramework.SymKey, params: cryptoFramework.ParamsSpec): Promise<cryptoFramework.DataBlob> {
     ...
     * @returns
     */
    static decryptCBCSync(data: cryptoFramework.DataBlob, symKey: cryptoFramework.SymKey, params: cryptoFramework.ParamsSpec): cryptoFramework.DataBlob {
